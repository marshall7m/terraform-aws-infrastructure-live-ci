...
| [null_resource.metadb_setup_account_dim](https://registry.terraform.io/providers/hashicorp/null/latest/docs/resources/resource) | resource |
| [null_resource.metadb_setup_tables](https://registry.terraform.io/providers/hashicorp/null/latest/docs/resources/resource) | resource |
| [null_resource.metadb_setup_user](https://registry.terraform.io/providers/hashicorp/null/latest/docs/resources/resource) | resource |
...
| <a name="input_metadb_cluster_arn"></a> [metadb\_cluster\_arn](#input\_metadb\_cluster\_arn) | Metadb cluster ARN that will be used for metadb setup queries (used for local metadb testing) | `string` | `null` | no |
...
| <a name="input_webhook_receiver_image_address"></a> [webhook\_receiver\_image\_address](#input\_webhook\_receiver\_image\_address) | Docker registry image to use for the webhook receiver Lambda Function. If not specified, this Terraform module's GitHub registry image<br>will be used with the tag associated with the version of this module. | `string` | `null` | no |

## Outputs

| Name | Description |
|------|-------------|
| <a name="output_account_parent_cfg"></a> [account\_parent\_cfg](#output\_account\_parent\_cfg) | AWS account-level configurations |
...
| <a name="output_commit_status_config"></a> [commit\_status\_config](#output\_commit\_status\_config) | Determines which commit statuses should be sent for each of the specified pipeline components |
...
| <a name="output_github_webhook_secret_ssm_key"></a> [github\_webhook\_secret\_ssm\_key](#output\_github\_webhook\_secret\_ssm\_key) | Key for the AWS SSM Parameter Store used to store GitHub webhook secret |

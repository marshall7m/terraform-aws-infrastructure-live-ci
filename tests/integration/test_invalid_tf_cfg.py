...
class TestInvalidTFConfig(test_integration.Integration):
    ...
    The error caused by the invalid Terraform configuration(s) within the dev-account should cause the Create Deploy Stack task to
    rollback the shared-services account's execution records and fail the task entirely without any other downstream services being invoked.
    """
